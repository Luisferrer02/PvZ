...
public class ShowRecordCommand extends Command implements Cloneable {
	...
	public boolean execute(GameWorld game) throws GameException{
		System.out.println(Messages.CURRENT_RECORD.formatted(game.getLevelName(), game.getRecord().getPoints()));
		return false; 		
	}
