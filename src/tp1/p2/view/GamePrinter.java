...
public class GamePrinter {
	...
	private static final String CELL_BORDER_CHAR = "_";
	...
	protected String getInfo() {
		...
		/* @formatter:off */
		buffer.append(Messages.NUMBER_OF_CYCLES + " " + game.getCycle() + Messages.LINE_SEPARATOR );
		buffer.append(Messages.NUMBER_OF_COINS + " "+ game.getSuncoins() + Messages.LINE_SEPARATOR );
		buffer.append(Messages.REMAINING_ZOMBIES + " " +game.getRemainingZombies() + Messages.LINE_SEPARATOR );
		buffer.append(Messages.GENERATED_SUNS + " " +game.getGeneratedSuns() + Messages.LINE_SEPARATOR);
		buffer.append(Messages.CAUGHT_SUNS + " "+game.getCaughtSuns() + Messages.LINE_SEPARATOR);
		buffer.append(Messages.SCORE + " " + game.getPoints()+Messages.LINE_SEPARATOR);
		/* @formatter:on */
